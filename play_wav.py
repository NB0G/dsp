...
from effects import AudioEffectChain, DEFAULT_EFFECT_SETTINGS
...
def build_chebyshev_filter_bank(sample_rate, band_gains_db=None):
    ...
    return Chebyshev2FilterBank(sample_rate, gains)
...
class EqualizerPlayer:
    def __init__(
        ...
        self.effect_settings = DEFAULT_EFFECT_SETTINGS.copy()
        self.filters = []
        self.effects = None
    ...
    def set_effect_settings(self, effect_settings):
        ...
        if self.effects is not None:
            self.effects.set_settings(self.effect_settings)
    ...
    def write_filtered_audio_to_buffer_dual_thread(self, wav_file):
        ...
        while frames and not self.stopped:
            ...
            filtered_samples = self.process_samples(samples)
